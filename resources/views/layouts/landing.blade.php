...
<head>
  ...
  <title>@yield('title', 'AzagiPrint — Cetak Tali Lanyard Custom Jakarta')</title>
  <meta name="description" content="@yield('meta_description', 'AzagiPrint — Desa Percetakan Online. Cetak Tali Lanyard custom Jakarta, MOQ 40 pcs, cetak 2 sisi Full Colour, gratis desain, kualitas terbaik.')">

  <!-- Open Graph -->
  <meta property="og:title" content="@yield('title', 'AzagiPrint — Cetak Tali Lanyard Custom Jakarta')">
  <meta property="og:description" content="AzagiPrint — Desa Percetakan Online. Cetak Tali Lanyard custom Jakarta, MOQ 40 pcs, cetak 2 sisi Full Colour, gratis desain.">
...
<body class="font-body text-gray-900 antialiased" style="background-color: #F8FAFC;">
  ...
  <nav class="landing-navbar fixed top-0 left-0 right-0 z-50 transition-all duration-300" style="background: transparent;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 lg:h-20">
        ...
        <div class="hidden md:flex items-center gap-6">
          ...
          <a href="https://wa.me/6282113328585?text=Halo%20AzagiPrint,%20saya%20tertarik%20dengan%20produk%20lanyard" target="_blank" class="font-cta text-sm font-semibold px-5 py-2.5 rounded-[5px] transition-all duration-300 inline-flex items-center gap-2" style="background-color: #25D366; color: white;">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white shadow-lg rounded-b-2xl mx-4 mb-2 overflow-hidden transition-all duration-300">
      <div class="px-4 py-4 space-y-3">
        ...
        <a href="https://wa.me/6282113328585?text=Halo%20AzagiPrint,%20saya%20tertarik%20dengan%20produk%20lanyard" target="_blank" class="block w-full text-center font-cta text-sm font-semibold px-5 py-3 rounded-[5px] text-white transition-all duration-300" style="background-color: #25D366;">
  ...
  <a href="https://wa.me/6282113328585?text=Halo%20AzagiPrint,%20saya%20tertarik%20dengan%20produk%20lanyard" target="_blank" class="whatsapp-widget hidden lg:flex" aria-label="Chat via WhatsApp">
  ...
  <div class="fixed bottom-4 left-4 right-4 z-50 lg:hidden">
    <div class="max-w-md mx-auto bg-white rounded-2xl shadow-[0_-8px_30px_rgba(0,0,0,0.12)] border border-gray-100/50 relative h-16 px-6 flex items-center justify-between">
      ...
      <div class="absolute -top-8 left-1/2 -translate-x-1/2 flex items-center justify-center">
        <a href="https://wa.me/6282113328585?text=Halo%20AzagiPrint,%20saya%20tertarik%20dengan%20produk%20lanyard" target="_blank" class="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-[0_8px_20px_rgba(37,211,102,0.4)] border-4 border-[#F8FAFC] hover:scale-105 transition-all duration-300" aria-label="Chat via WhatsApp">
